...
public class testGoGoEat {
	...
	public void testDefaultGetTableArrangementResult() throws ExPeopleNumExceedTotalCapacity {
		...
		tableArrangementResults = dtaa.getTableArrangementResult(peopleNum, availableTables, tableCapacityTypeList,
				allTables);
	...
	@Test
	public void testDefaultGetTableArrangementResultPPLNumEqualCapacityLastTable()
	...
	@Test
	public void testDefaultGetTableArrangementResultPPLNumEqualCapacityNotLastTable()
			throws ExPeopleNumExceedTotalCapacity {
		DefaultTableArrangementAlgorithm dtaa = DefaultTableArrangementAlgorithm.getInstance();
	...
	@Test
	public void testCancelReservationNotReserved() throws ExCustomersIdNotFound, ExTableIdAlreadyInUse, ExTableNotExist,
	...
	@Test
	public void testCheckOutByCustomer()
			throws ExTableIdAlreadyInUse, ExPeopleNumExceedTotalCapacity, ExCustomersIdNotFound {
		tm.addNewTable(11, 2);
		tm.addNewTable(12, 4);
	...
	@Test
	void testReservationToString2() throws ExTableNotExist, ExTimeSlotAlreadyBeReserved, ExTimeSlotInvalid,
			ExTimeFormatInvalid, ExTableIdAlreadyInUse {
		initialization.initialize();
		ArrayList<Integer> table = new ArrayList<Integer>();
		table.add(1);
		Reservation r = new Reservation("C0001", "08:00-10:00", table, ManualClock.getDate());
	...
	@Test
	public void testCustomerUpdateOrders() throws ExTableIdAlreadyInUse, ExTableNotExist, ExTimeSlotAlreadyBeReserved,
	...
	@Test
	public void testCustomerUpdateState() throws ExTableIdAlreadyInUse, ExTableNotExist, ExTimeSlotAlreadyBeReserved,
			ExTimeSlotInvalid, ExTimeFormatInvalid {
		Customers c = new Customers("tester", "C0008");
		c.setBillAmount(89);
		c.updateState();
